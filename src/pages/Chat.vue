  ...
  <section class="flex w-full">
    <div class="m-auto">
      ...
      <div class="border rounded-lg">
        <div class="h-64 p-2">
          <div v-for="chat in state.chats" :key="chat.message" :class="chat.userId === state.userId ? 'text-right' : 'text-left'">
            {{ chat.message }}
          </div>
        </div>
      </div>
...
import firebase, { chatsRefs } from '../utilities/firebase'
export default {
  setup(){
